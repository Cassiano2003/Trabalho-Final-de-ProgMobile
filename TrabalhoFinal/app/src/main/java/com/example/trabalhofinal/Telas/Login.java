                    ...
                    if(!nomeLogin.isEmpty() && !senha.isEmpty()){
                        if(db.usuarioDao().buscaNome(nomeLogin) || db.usuarioDao().buscaEmai(nomeLogin)){
                            ...
                            if(checkPassword(senha,usuario.getSenha())){
                                Toast.makeText(requireContext(), "Usuario Valido", Toast.LENGTH_LONG).show();
                            ...
                            Toast.makeText(requireContext(), "Usuario nao encontrado", Toast.LENGTH_LONG).show();
                        }
                    }else {
                        Toast.makeText(requireContext(), "Nome e Senha invalidos", Toast.LENGTH_LONG).show();
                    }
