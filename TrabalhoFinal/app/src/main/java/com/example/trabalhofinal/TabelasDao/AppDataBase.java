...
@Database(entities = {Usuario.class, Akumas.class, Tripulacoes.class, Inimigos.class, Personagens.class},version = 12)//Almentar as vesoes se colocar mais classes
...
public abstract class AppDataBase extends RoomDatabase {
    ...
    public abstract PersonagensDao personagensDao();
